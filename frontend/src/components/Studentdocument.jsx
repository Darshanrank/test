...
const Studentdocument = () => {
    ...
    const fetchDocuments = async () => {
        try {
            const response = await axios.get(`${Api}/api/student-documents/${studentId}`);
    ...
    const handleDeleteDocument = async (docType) => {
        try {
            const response = await axios.delete(`${Api}/api/student-documents/delete/${studentId}/${docType}`);
